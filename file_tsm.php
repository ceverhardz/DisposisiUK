                ...
                echo '
                    <div class="row jarak-form">
                                        ...
                                        <div class="col m12 white">
                                            <table>
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td width="13%">Feedback</td>
                                                        <td width="1%">:</td>
                                                        <td width="86%">'.$row['feedback'].'</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                        ...
                        if(empty($row['file'])){
                            ...
                            $x = explode('.', $file_feedback);
                            $eks = strtolower(end($x));

                            if(in_array($eks, $ekstensi) == true){
                                echo '<img class="gbr" data-caption="'.date('d M Y', strtotime($row['tgl_diterima'])).'" src="./upload/feedback/'.$row['file_feedback'].'"/>';
                            } else {
                                                ...
                                                <div class="col s9 left">
                                                    <div class="card">
                                                        ...
                                                        <div class="card-action">
                                                            <strong>Lihat file :</strong> <a class="blue-text" href="./upload/feedback/'.$row['file_feedback'].'" target="_blank">'.$row['file_feedback'].'</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col s12">
                                                <div class="col s9 left">
                                                    <div class="card">
                                                        ...
                                                        <div class="card-action">
                                                            <strong>Lihat file :</strong> <a class="blue-text" href="./upload/surat_masuk/'.$row['file_feeback'].'" target="_blank">'.$row['file_feeback'].'</a>
                                                        </div>
                                                    </div>
                                                </div>
